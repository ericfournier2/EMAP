...
epigenetic_Target <- "Epigenetic.target"
transcriptomic_Target <- "Transcriptomic.target"
...
epigenetic_Folder <- "Raw/Rachele"
transcriptomic_Folder <- "Raw/Rachele"
...
epigenetic_Name <- "Rachele0.1/Epigenetic"
transcriptomic_Name <- "Rachele0.1/Transcriptomic"
...
combined_Name <- "Rachele0.1/Combined"

# 9. Set thresholds for significance.
epi_foldchange_Threshold <- log2(1.4)
epi_pvalue_Threshold <- 0.1
