...
epigenetic_Target <- "Karolien.target"
transcriptomic_Target <- "Karolien.target"
...
epigenetic_Folder <- "Raw/Karolien/IVM/Epigenetic"
transcriptomic_Folder <- "Raw/Karolien/IVM/Transcriptomic"
...
epigenetic_Name <- "Karolien/IVM/Epigenetic"
transcriptomic_Name <- "Karolien/IVM/Transcriptomic"
...
reference_Condition <- "Basal"

# 8 Set a name for the results of the "Combined" analysis.
combined_Name <- "Karolien/IVM/Combined"
