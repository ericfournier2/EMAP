...
epigenetic_Folder <- "Raw/Florence"
transcriptomic_Folder <- "Raw/Florence"
...
epigenetic_Name <- "Florence/Epigenetic"
transcriptomic_Name <- "Florence/Transcriptomic"
...
combined_Name <- "Florence/Combined"
